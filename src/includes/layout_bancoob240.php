...
<title><?php echo $dadosboleto['identificacao']; ?></title>
    ...
    <body text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
        <table width=666 border-collapse=collapse border-spacing=0  padding=0 border=0>
            <tr>
        ...
        <table border-collapse=collapse border-spacing=0  padding=0 border=0>
            <tbody>
                <tr>
                    ...
                    <td class=ct vertical-align=top width=298 height=13>Cedente</td>
                    <td class=ct vertical-align=top width=7 height=13><img height=13 src="<?php echo $boleto->getImageBasePath() ?>1.png" width=1 border=0></td>
                    <td class=ct vertical-align=top width=126 height=13>Agência/Código do Cedente</td>
                    <td class=ct vertical-align=top width=7 height=13><img height=13 src="<?php echo $boleto->getImageBasePath() ?>1.png" width=1 border=0></td>
                    <td class=ct vertical-align=top width=34 height=13>Espécie</td>
                    <td class=ct vertical-align=top width=7 height=13><img height=13 src="<?php echo $boleto->getImageBasePath() ?>1.png" width=1 border=0></td>
                    <td class=ct vertical-align=top width=53 height=13>Quantidade</td>
                    <td class=ct vertical-align=top width=7 height=13><img height=13 src="<?php echo $boleto->getImageBasePath() ?>1.png" width=1 border=0></td>
                    <td class=ct vertical-align=top width=120 height=13>Nosso número</td>
                </tr>
                <tr>
                    ...
                    <td class=cp vertical-align=top width=298 height=12><span class="campo"><?php echo $dadosboleto['cedente']; ?></span></td>
                    <td class=cp vertical-align=top width=7 height=12><img height=12 src="<?php echo $boleto->getImageBasePath() ?>1.png" width=1 border=0></td>
                    <td class=cp vertical-align=top width=126 height=12>
                        <span class="campo">
                    ...
                    <td class=cp vertical-align=top width=7 height=12><img height=12 src="<?php echo $boleto->getImageBasePath() ?>1.png" width=1 border=0></td>
                    <td class=cp vertical-align=top  width=53 height=12>
                        <span class="campo">
                            <?php echo $dadosboleto['quantidade'] ?>
                        </span>
                    </td>
                    <td class=cp vertical-align=top width=7 height=12><img height=12 src="<?php echo $boleto->getImageBasePath() ?>1.png" width=1 border=0></td>
                    <td class=cp vertical-align=top align=right width=120 height=12>
                        <span class="campo">
                ...
                <tr>
                    ...
                    <td vertical-align=top width=298 height=1><img height=1 src="<?php echo $boleto->getImageBasePath() ?>2.png" width=298 border=0></td>
                    <td vertical-align=top width=7 height=1><img height=1 src="<?php echo $boleto->getImageBasePath() ?>2.png" width=7 border=0></td>
                    <td vertical-align=top width=126 height=1><img height=1 src="<?php echo $boleto->getImageBasePath() ?>2.png" width=126 border=0></td>
                    <td vertical-align=top width=7 height=1><img height=1 src="<?php echo $boleto->getImageBasePath() ?>2.png" width=7 border=0></td>
                    ...
                    <td vertical-align=top width=7 height=1><img height=1 src="<?php echo $boleto->getImageBasePath() ?>2.png" width=7 border=0></td>
                    <td vertical-align=top width=120 height=1><img height=1 src="<?php echo $boleto->getImageBasePath() ?>2.png" width=120 border=0></td>
                </tr>
            </tbody>
        </table>
        <table border-collapse=collapse border-spacing=0  padding=0 border=0>
